...
def get_config(num_train_models):
    ...
    for i in range(len(subtasks)):
        config.tokenizer_paths.append(f"/fsx-project/yunyun/models/meta-llama_Llama2-7b_{subtasks[i]}_tuned")
    ...
    for i in range(len(subtasks)):
        config.model_paths.append(f"/fsx-project/yunyun/models/meta-llama_Llama2-7b_{subtasks[i]}_tuned")
