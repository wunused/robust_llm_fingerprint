...
class ModelArguments:
    ...
    embedding_only: bool = field(
        default=False,
        metadata={"help": "Whether to use embedding only or not."},)
    lora_r: int = field(
...
def train():
    ...
    if model_args.model_name_or_path:
        config = transformers.AutoConfig.from_pretrained(model_args.model_name_or_path, **config_kwargs)
    ...
    if model_args.embedding_only:
        ...
        if hasattr(model, "enable_input_require_grads"):
            ...
            print("make_inputs_require_grad!")
        ...
        print('Finetune with LORA setting: ', model.print_trainable_parameters())
    else:
        model = transformers.AutoModelForCausalLM.from_pretrained(
            model_args.model_name_or_path,
            cache_dir=training_args.cache_dir,
    ...
    trainer = Trainer(model, args=training_args, tokenizer=tokenizer, **data_module)
